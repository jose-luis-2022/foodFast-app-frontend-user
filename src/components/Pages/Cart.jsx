  ...
  return (
    <div className="bg-[#f8f9fa]">
      ...
      <main className="w-full flex flex-col md:flex-row">
        <Sidebar />
        <div className="md:w-[85%] h-[70vh] lg:my-10 font-Mulish flex flex-col lg:justify-center lg:flex-row px-5 sm:px-0">
          <h1
            className={`${
          ...
          >
            ...
            <div className="flex p-5 bg-white max-h-[500px] overflow-y-scroll">
              <table
                className={`${productsCart.length === 0 && "hidden"} w-full`}
              >
                <tbody>
                  <tr>
          ...
          >
            <div className="flex flex-col justify-center items-center space-y-3">
              ...
              <p className="text-normal sm:text-lg">
